...
GROUP_4_SPECIFIC = {
    "saturday": [
        ...
        {"time_start": "14:40", "time_end": "16:10", "course": "Analysis1", "location": "Room C206", "type": "Tutorial Session"},
    ],
    "sunday": [
        {"time_start": "09:40", "time_end": "11:10", "course": "Analysis1", "location": "Room 301D", "type": "Tutorial Session"},
        {"time_start": "11:20", "time_end": "12:50", "course": "Algebra1", "location": "Room R3", "type": "Tutorial Session"},
    ],
    "monday": [
        {"time_start": "09:40", "time_end": "11:10", "course": "Algorithm1", "location": "Lab E0.05", "type": "Laboratory Session", "alternating": True, "alternating_key": "algorithm1"},
    ],
    "tuesday": [
        {"time_start": "13:00", "time_end": "14:30", "course": "Algorithm1", "location": "Room R6", "type": "Tutorial Session"},
    ],
    "thursday": [
...
def init_group4_schedule():
    """Initialize Group 4 schedule in database."""
    print("Initializing Group 4 schedule...")
    ...
    print("\n[SUCCESS] Group 4 schedule initialized successfully!")

if __name__ == "__main__":
    init_group4_schedule()
